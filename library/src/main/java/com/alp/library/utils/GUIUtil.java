...
public final class GUIUtil {
    ...
    public static void showRevealEffect(final View v, int centerX, int centerY, @Nullable Animator.AnimatorListener lis) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            set.setDuration(ANIMATION_DURATION_MEDIUM);
